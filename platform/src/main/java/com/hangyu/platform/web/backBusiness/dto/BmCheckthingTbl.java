...
public class BmCheckthingTbl {
    private Integer id;

    private String chkthingid;
    ...
    public String getChkthingid() {
        return chkthingid;
    }

    public void setChkthingid(String chkthingid) {
        this.chkthingid = chkthingid == null ? null : chkthingid.trim();
    }
