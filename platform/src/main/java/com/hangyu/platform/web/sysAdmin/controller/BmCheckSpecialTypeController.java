 ...
 */
@RestController
@RequestMapping("v1/bmCheckType/")
@Api(tags = "现场检查问题类型管理")
public class BmCheckSpecialTypeController {

    Result result = new Result(ResultStatusEnum.SUCCESS.getCode(), ResultStatusEnum.SUCCESS.getMessage());


    @Autowired
    private BmCheckSpecialTypeService service;
     ...
     * @return
     */
    @ApiOperation(value = "增加现场检查问题类型{author:liuxuan}", response = Result.class)
     ...
     * @return
     */
    @ApiOperation(value = "修改现场检查问题类型{author:liuxuan}", response = Result.class)
     ...
     * @return
     */
    @ApiOperation(value = "删除现场检查问题类型{author:liuxuan}", response = Result.class)
